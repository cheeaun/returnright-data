...
_Snapshot: **2026-08-20** · 1,257 locations · `data/latest.json` · as of 20 Aug 2026, 16:22 UTC_

## Current snapshot

| Metric | Value |
| --- | --- |
| Total locations | 1,257 |
| Unique serials | 1,257 |
| Unique postal codes | 1,216 |
...
| --- | --- | --- | --- | --- | --- | --- |
| RVMS001 | 3 | 10 | 2 | 0 | 353 | 368 |
| SGRECYCLE001 | 4 | 7 | 1 | 5 | 398 | 415 |
| TOMRA001 | 6 | 14 | 2 | 9 | 443 | 474 |
...
xychart-beta
    ...
    bar [169, 147, 126, 105, 100, 80, 70, 68, 54, 50, 40, 40, 29, 27, 25, 18, 18, 16, 16, 12, 9, 8, 7, 7, 6, 5, 4, 1]
```
...
| S73 | D25 | Admiralty, Woodlands, Kranji, Woodgrove | 67 | 5.3% |
...
## History (135 snapshots · 2026-04-08 → 2026-08-20)

| Metric | Value |
| --- | --- |
| First snapshot | 1,069 |
| Current snapshot | 1,252 |
| Net change | +183 |
| Minimum | 1,069 (2026-04-08) |
| Maximum | 1,252 (2026-08-20) |
| Average | 1,130 |
...
xychart-beta
    ...
    y-axis "machines" 0 --> 1440
    line [1069, 1090, 1152, 1206, 1252]
```
...
**Retention:** 97.9% of the first snapshot's machines are still present (1047/1,069).
