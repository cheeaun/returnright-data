...
_Snapshot: **2026-08-19** · 1,252 locations · `data/latest.json` · as of 19 Aug 2026, 16:22 UTC_

## Current snapshot

| Metric | Value |
| --- | --- |
| Total locations | 1,252 |
| Unique serials | 1,252 |
| Unique postal codes | 1,212 |
| Shared postal codes | 36 postcodes host 40 extra machines |
...
xychart-beta
    ...
    y-axis "machines" 0 --> 1185
    line [799, 799, 801, 846, 987, 1027, 1030, 1030, 1030, 1030, 1028, 984]
```

- Typical window: **07:00 → 23:00**
- Earliest open: **05:30**
- Latest close: **24:00**
- Peak: **1,030 machines** at **13:00**
...
| --- | --- | --- | --- | --- | --- | --- |
| RVMS001 | 4 | 5 | 1 | 0 | 358 | 368 |
| SGRECYCLE001 | 1 | 11 | 0 | 4 | 400 | 416 |
| TOMRA001 | 3 | 16 | 1 | 7 | 441 | 468 |
...
xychart-beta
    ...
    x-axis ["D18", "D19", "D23", "D22", "D16", "D27", "D14", "D25", "D20", "D03", "D05", "D12", "D15", "D13", "D10", "D09", "D01", "D04", "D08", "D28", "D17", "D07", "D02", "D21", "D11", "D06", "D24", "D26"]
    y-axis "machines" 0 --> 195
    bar [169, 145, 126, 105, 100, 82, 68, 68, 54, 50, 40, 40, 29, 27, 24, 19, 18, 16, 12, 12, 9, 8, 7, 7, 6, 5, 5, 1]
```
...
| S82 | D19 | Serangoon Gardens, Hougang, Punggol, Sengkang | 57 | 4.6% |
| S76 | D27 | Yishun, Sembawang | 55 | 4.4% |
| S68 | D23 | Hillview, Dairy Farm, Bukit Panjang, Choa Chu Kang | 52 | 4.2% |
| S53 | D19 | Serangoon Gardens, Hougang, Punggol, Sengkang | 43 | 3.4% |
...
| S75 | D27 | Yishun, Sembawang | 27 | 2.2% |
...
| S27 | D10 | Tanglin, Ardmore, Holland, Bukit Timah | 11 | 0.9% |
...
| S22 | D09 | Orchard, Cairnhill, River Valley | 4 | 0.3% |
...
xychart-beta
    ...
    y-axis "machines" 0 --> 977
    bar [198, 849, 3, 30, 56, 56, 60]
```
...
| --- | --- | --- | --- | --- |
| 1 | Block 232C Sumang Lane | 823232 | RUNNING | 18 Aug 2026 |
| 2 | Block 423A Northshore Crescent | 823423 | RUNNING | 18 Aug 2026 |
| 3 | Block 326B Sumang Walk | 822326 | RUNNING | 18 Aug 2026 |
| 4 | Block 228A Punggol Field | 821228 | RUNNING | 18 Aug 2026 |
| 5 | Block 217C Sumang Walk | 823217 | RUNNING | 18 Aug 2026 |
...
| 2 | 715 Jurong West Street 71 | 640715 | FULL | 21 Feb 2026 |
...
## History (134 snapshots · 2026-04-08 → 2026-08-19)

| Metric | Value |
| --- | --- |
| First snapshot | 1,069 |
| Current snapshot | 1,241 |
| Net change | +172 |
...
xychart-beta
    ...
    y-axis "machines" 0 --> 1428
    line [1069, 1090, 1152, 1206, 1241]
```
