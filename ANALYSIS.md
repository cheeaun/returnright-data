...
_Snapshot: **2026-08-18** · 1,241 locations · `data/latest.json` · as of 18 Aug 2026, 16:22 UTC_

## Current snapshot

| Metric | Value |
| --- | --- |
| Total locations | 1,241 |
| Unique serials | 1,241 |
| Unique postal codes | 1,201 |
...
xychart-beta
    ...
    y-axis "machines" 0 --> 1180
    line [798, 798, 799, 843, 984, 1023, 1026, 1026, 1026, 1026, 1024, 980]
```

- Typical window: **07:00 → 23:00**
- Earliest open: **05:30**
- Latest close: **24:00**
- Peak: **1,026 machines** at **13:00**
- **228** machines with limited hours open all 7 days

### Status by supplier

| Supplier | ERROR | FULL | MAINTENANCE | OFFLINE | RUNNING | Total |
| --- | --- | --- | --- | --- | --- | --- |
| RVMS001 | 3 | 15 | 3 | 1 | 347 | 369 |
| SGRECYCLE001 | 6 | 3 | 0 | 8 | 394 | 411 |
| TOMRA001 | 7 | 9 | 1 | 8 | 436 | 461 |
...
xychart-beta
    ...
    x-axis ["D18", "D19", "D23", "D22", "D16", "D27", "D14", "D25", "D20", "D03", "D05", "D12", "D15", "D13", "D10", "D09", "D01", "D04", "D28", "D08", "D17", "D07", "D02", "D21", "D11", "D06", "D24", "D26"]
    y-axis "machines" 0 --> 196
    bar [170, 137, 126, 104, 100, 80, 68, 67, 54, 50, 40, 40, 29, 27, 24, 19, 18, 16, 13, 12, 9, 8, 7, 7, 6, 5, 4, 1]
```
...
| --- | --- | --- | --- | --- |
| S52 | D18 | Pasir Ris, Tampines | 109 | 8.8% |
| S46 | D16 | Bedok, Upper East Coast, Eastwood, Kew Drive | 74 | 6.0% |
| S73 | D25 | Admiralty, Woodlands, Kranji, Woodgrove | 64 | 5.2% |
| S51 | D18 | Pasir Ris, Tampines | 61 | 4.9% |
| S64 | D22 | Boon Lay, Jurong, Tuas | 58 | 4.7% |
...
xychart-beta
    ...
    y-axis "machines" 0 --> 972
    bar [198, 845, 3, 31, 56, 56, 52]
```
...
| --- | --- | --- | --- | --- |
| 1 | 60 Jurong West Central 3 | 648346 | RUNNING | 17 Aug 2026 |
| 2 | 414 Pandan Gardens Road | 600414 | RUNNING | 16 Aug 2026 |
| 3 | 48 Teban Gardens Road | 600048 | RUNNING | 16 Aug 2026 |
| 4 | 601 Jurong West Street 62 | 640601 | RUNNING | 14 Aug 2026 |
| 5 | 640 Jurong West Street 61 | 640640 | RUNNING | 14 Aug 2026 |
...
## History (133 snapshots · 2026-04-08 → 2026-08-18)

| Metric | Value |
| --- | --- |
| First snapshot | 1,069 |
| Current snapshot | 1,243 |
| Net change | +174 |
...
xychart-beta
    ...
    y-axis "machines" 0 --> 1430
    line [1069, 1090, 1152, 1206, 1243]
```
